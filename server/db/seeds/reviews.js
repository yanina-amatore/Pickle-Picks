...
exports.seed = async function (knex) {
  ...
  await knex('reviews').insert([
    ...
    },
    {
      id: 2,
      location:
        'Ground Floor/232 Oriental Parade, Oriental Bay, Wellington 6011',
      title: 'Beach Babylon',
    ...
    {
      id: 3,
      location: '14 Jessie Street, Te Aro, Wellington 6011',
      title: 'Prefab Eatery',
    ...
    {
      id: 4,
      location: '84 Rotherham Terrace, Miramar, Wellington 6022',
      title: 'Cafe Polo',
